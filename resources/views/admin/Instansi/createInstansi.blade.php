            ...
            <form action="{{ route('instansi.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="jenis_instansi" id="jenis_instansi"
                        ...
                        <option value="" disabled {{ old('jenis_instansi') ? '' : 'selected' }}>Pilih Jenis Instansi</option>
                        ...
                        <option value="Perusahaan Swasta" {{ old('jenis_instansi') == 'Perusahaan Swasta' ? 'selected' : '' }}>Perusahaan Swasta</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="skala_instansi" id="skala_instansi"
                        ...
                        <option value="" disabled {{ old('skala_instansi') ? '' : 'selected' }}>Pilih Skala Instansi</option>
                        <option value="Wirausaha" {{ old('skala_instansi') == 'Wirausaha' ? 'selected' : '' }}>Wirausaha</option>
                        <option value="Nasional" {{ old('skala_instansi') == 'Nasional' ? 'selected' : '' }}>Nasional</option>
                        <option value="Multinasional" {{ old('skala_instansi') == 'Multinasional' ? 'selected' : '' }}>Multinasional</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="lokasi_instansi" id="lokasi_instansi"
                        ...
                        value="{{ old('lokasi_instansi') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="no_hp_instansi" id="no_hp_instansi"
                        ...
                        value="{{ old('no_hp_instansi') }}" required pattern="[0-9]+"
